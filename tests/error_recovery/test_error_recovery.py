...
class TestE2DisplayFailure:
    ...
    @pytest.mark.asyncio
    async def test_hdmi_display_connected_and_active(
        self, 
        provisioning_orchestrator
    ):
    ...
    @pytest.mark.asyncio
    async def test_error_logging_on_display_failure(
        self, 
        provisioning_orchestrator
    ):
        ...
        # Simulate display failure
        with patch.object(display_service, 'show_qr_code', return_value=False) as mock_qr:
    ...
    @pytest.mark.asyncio
    async def test_hdmi_detection_and_recovery(
        self, 
        provisioning_orchestrator
    ):
    ...
    @pytest.mark.asyncio
    async def test_display_health_monitoring(
        self, 
        provisioning_orchestrator
    ):
