...
class EventBus:
    ...
    def subscribe_async(self, event_type: EventType, handler: Callable[[Event], Any]) -> str:
    ...
    async def publish_async(self, event_type: EventType, data: Any, source: str = "unknown") -> None:
